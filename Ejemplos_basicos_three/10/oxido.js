// File oxido.js
 ...
 //Create the Three.js WebGL renderer
  ...
  var controls = new function(){
	...
	//loader.load( 'oxido.obj', 'oxido.mtl', function ( object ) {	
	//loader.load( 'untitled.obj', 'untitled.mtl', function ( object ) {				
  loader.load( 'plano.obj', 'plano.mtl', function ( object ) {	
					wholeobject = object;
					wholeobject.position.y = 0;
					wholeobject.scale.set(40,40,40);
					scene.add( wholeobject );		
 /*         wholeobject.traverse( function ( object2 ) {
     if ( object2 instanceof THREE.Mesh ) {
       if ( object2.material.name == "Material2") {
         cubo = object2;
         } else if ( object2.material.name == "Material.001") {
           plano = object2;
         }
     }
   }); */
 ...
 var light = new THREE.DirectionalLight(controls.color1, 2);
  light.position.set(controls.lightx, controls.lighty, controls.lightz);
  scene.add(light);
  
  var light3 = new THREE.PointLight(controls.color3, 0.6);
  light3.position.set(controls.light3x, controls.light3y, controls.light3z);
  scene.add(light3);
  
    
  var light2 = new THREE.PointLight(controls.color2, 0.6);
