// File 6.js
 ...
 //Create the Three.js WebGL renderer
  ...
  var mapUrl = "wotig.png";
    ...
    var geometry2 = new THREE.CylinderGeometry(200, 200, 400, 4, 1, false);
  ...
  // Generazione ombre
  light.castShadow = true;    // la luce direzionale genera ombra
  light2.castShadow = false;
  light3.castShadow = false;
  mesa.receiveShadow = true;  // il piano di mesa rivece ombra
  ...
  var pointLightHelper2 = new THREE.PointLightHelper(light2, 5);
    scene.add(pointLightHelper2);
  var pointLightHelper3 = new THREE.PointLightHelper(light3, 5);
